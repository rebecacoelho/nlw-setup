...
import { genereteDatesFromYearBeginning } from "../utils/generate-dates-from-year-beginning"
...
const minimunSummaryDatesSize = 17 * 7 // 17 weeks
...
export function SummaryTable() {
  ...
  }, []) // array vazio = código da função só executa 1 vez
